        ...
        <div class="container">
            <div class="row gutters-10 position-relative">
                ...
                <div class=" col-lg-2 position-static order-2 order-lg-0 d-none d-lg-block">
                    <div class="bg-white border_padding" >
                        <div class="row no-gutters" style="padding-left: 5px;">
                            <div class="col-2">
                                <img src="{{ static_asset('assets/img/1.png') }}" class="mt-2 align_items" style="height: 35px; position: absolute; float: left; border: none;" alt="Help Center">
                            </div>
                            <div class="col-10" style="padding-left: 10px; margin-top: 5px;">
                                <span style="font-weight: bold;">{{ translate('HELP CENTER')}}</span><br/>
                                <span>{{ translate('Guide To Customer Care')}}</span>
                            </div>
                            <div class="col-2">
                                <img src="{{ static_asset('assets/img/2.png') }}" class="mt-2 align_items" style="height: 35px; position: absolute; float: left; border: none;" alt="Easy Return">
                            </div>
                            <div class="col-10" style="padding-left: 10px; margin-top: 5px;">
                                <span style="font-weight: bold;">{{ translate('EASY RETURN')}}</span><br/>
                                <span>{{ translate('Quick Refund')}}</span>
                            </div>
                            <div class="col-2">
                                <img src="{{ static_asset('assets/img/3.png') }}" class="mt-2 align_items" style="height: 35px; position: absolute; float: left; border: none;" alt="Sell on Kulmart">
                            </div>
                            <div class="col-10" style="padding-left: 10px; margin-top: 5px;">
                                <span style="font-weight: bold; text-transform: uppercase;">{{ translate('SELL ON KULMART')}}</span><br/>
                                <span>{{ translate('Millions Of Visitors')}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white border_padding" style="margin-top: 5px;">
                        <div class="row no-gutters">
                            <img src="{{ static_asset('assets/img/4.png') }}" class="mt-2 align_items" style="height: 200px; border: none;" alt="Kulmart Ads">
                        </div>
                    </div>
                </div>
            ...
            <div class="row gutters-10">
                @if (get_setting('home_banner1_images') != null)
                    ...
                    @foreach ($banner_1_imags as $key => $value)
                        <div class="col-lg-{{ 12/count($banner_1_imags) }}">
            ...
            <div class="row gutters-10">
                @if (get_setting('home_banner2_images') != null)
                    ...
                    @foreach ($banner_2_imags as $key => $value)
                        <div class="col-lg-{{ 12/count($banner_2_imags) }}">
                            <div class="mb-3 mb-lg-0">
