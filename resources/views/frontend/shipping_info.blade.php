                                        ...
                                        <label class="aiz-megabox d-block bg-white mb-0">
                                            ...
                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                ...
                                                <span class="flex-grow-1 pl-3 text-left">
                                                    <div>
                                                        <span class="opacity-60">{{ translate('Delivery Address') }}:</span>
                                                    ...
                                                    <div>
                                                        <span class="opacity-60">{{ translate('County') }}:</span>
                        ...
                        @else
                            <div class="shadow-sm bg-white p-4 rounded mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">{{ translate('Select your County')}}</label>
                                            <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="country" required>
                                                @foreach (DB::table('county')->pluck('countyName') as $country)
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">
                                            <label class="control-label">{{ translate('Select City')}}</label>
                                            <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="city" required>
                                                @foreach (DB::table('sub_county')->pluck('subCounty') as $sub_county)
...
@section('modal')
<div class="modal fade bd-example-modal-lg" id="new-address-modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control textarea-autogrow mb-3" placeholder="{{ translate('Delivery Address')}}" rows="1" name="address" required></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                                <label>{{ translate('Select County')}}</label>
                            </div>
                            <div class="col-md-10">
                                <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="country" required>
                                    @foreach (DB::table('county')->pluck('countyName') as $country)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('+254')}}" name="phone" value="" required>
                            </div>
                        </div>
                    </div>
                </div>
