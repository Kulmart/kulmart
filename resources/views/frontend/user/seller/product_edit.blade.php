...
@section('content')
    ...
    <section class="py-5">
        ...
        <div class="card">
			<div class="card-header">
				<h5 class="mb-0 h6">{{translate('Product Specification')}}</h5>
			</div>
			<div class="card-body">
				<div class="form-group row">
					<label class="col-md-3 col-from-label">{{translate('Specifications')}}</label>
					<div class="col-md-8">
						<textarea class="aiz-text-editor" name="specifications">{{$product->getTranslation('specifications')}}</textarea>
					</div>
				</div>
			</div>
		</div>
		<div class="card">
			<div class="card-header">
				<h5 class="mb-0 h6">{{translate('Key Features')}}</h5>
			</div>
			<div class="card-body">
				<div class="form-group row">
					<label class="col-md-3 col-from-label">{{translate('Key features')}}</label>
					<div class="col-md-8">
						<textarea class="aiz-text-editor" name="keyf">{{$product->getTranslation('keyf')}}</textarea>
					</div>
				</div>
			</div>
		</div>
		<div class="card">
			<div class="card-header">
				<h5 class="mb-0 h6">{{translate('What is in the Box')}}</h5>
			</div>
			<div class="card-body">
				<div class="form-group row">
					<label class="col-md-3 col-from-label">{{translate('Whats in the Box')}}</label>
					<div class="col-md-8">
						<textarea class="aiz-text-editor" name="witb">{{$product->getTranslation('witb')}}</textarea>
					</div>
				</div>
			</div>
		</div>
